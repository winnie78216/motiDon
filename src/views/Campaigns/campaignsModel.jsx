...
const CampaignsRecord = Record({
    data: [
        ...
        },
        {
            ...
            description: 'At this critical time, our services are desperately needed (see below), which is why we are launching this effort to help fund our operations that would enable us to assist as many Palestinians in need as possible. Humanity has many possible futures. Nobody is immune to our epidemic of separation and despair. Current Affairs is the only publication guaranteed to regularly contain both in-depth domestic policy analysis and pictures of colorful flamingos.',
